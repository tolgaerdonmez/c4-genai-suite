...
export type ModelConfiguration =
  | ({ type: 'ANSWER_RELEVANCY' } & AnswerRelevancyMetricConfigurationRead)
  | ({ type: 'FAITHFULNESS' } & FaithfulnessMetricConfigurationRead)
  | ({ type: 'G_EVAL' } & GEvalMetricConfigurationRead)
  | ({ type: 'HALLUCINATION' } & HallucinationMetricConfigurationRead);
...
export function ModelConfigurationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelConfiguration {
  ...
  switch (json['type']) {
    case 'ANSWER_RELEVANCY':
      return Object.assign({}, AnswerRelevancyMetricConfigurationReadFromJSONTyped(json, true), {
