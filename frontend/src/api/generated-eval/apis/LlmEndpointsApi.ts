...
export class LlmEndpointsApi extends runtime.BaseAPI {
     ...
     * Delete
     */
    async llmEndpointsDeleteRaw(requestParameters: LlmEndpointsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        ...
        const response = await this.request({
            path: `/v1/llm-endpoints/{llm_endpoint_id}`.replace(`{${"llm_endpoint_id"}}`, encodeURIComponent(String(requestParameters['llmEndpointId']))),
            method: 'DELETE',
     ...
     * Delete
     */
    async llmEndpointsDelete(llmEndpointId: string, lLMEndpointDelete: LLMEndpointDelete, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.llmEndpointsDeleteRaw({ llmEndpointId: llmEndpointId, lLMEndpointDelete: lLMEndpointDelete }, initOverrides);
     ...
     * Get
     */
    async llmEndpointsGetRaw(requestParameters: LlmEndpointsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LLMEndpoint>> {
        if (requestParameters['llmEndpointId'] == null) {
            throw new runtime.RequiredError(
                'llmEndpointId',
     ...
     * Get All
     */
    async llmEndpointsGetAllRaw(requestParameters: LlmEndpointsGetAllRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LLMEndpoint>>> {
        const queryParameters: any = {};
     ...
     * Get All
     */
    async llmEndpointsGetAll(q?: string | null, supportedFeatures?: Array<PluginFeature> | null, offset?: number, limit?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LLMEndpoint>> {
        const response = await this.llmEndpointsGetAllRaw({ q: q, supportedFeatures: supportedFeatures, offset: offset, limit: limit }, initOverrides);
        return await response.value();
    }
     ...
     * Get Types
     */
    async llmEndpointsGetTypesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LLMEndpointTypesResponse>> {
        const queryParameters: any = {};
     ...
     * Patch
     */
    async llmEndpointsPatchRaw(requestParameters: LlmEndpointsPatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LLMEndpoint>> {
        if (requestParameters['llmEndpointId'] == null) {
            throw new runtime.RequiredError(
                'llmEndpointId',
     ...
     * Patch
     */
    async llmEndpointsPatch(llmEndpointId: string, lLMEndpointUpdate: LLMEndpointUpdate, xUserId?: string | null, xUserName?: string | null, xUserEmail?: string | null, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LLMEndpoint> {
        const response = await this.llmEndpointsPatchRaw({ llmEndpointId: llmEndpointId, lLMEndpointUpdate: lLMEndpointUpdate, xUserId: xUserId, xUserName: xUserName, xUserEmail: xUserEmail }, initOverrides);
        return await response.value();
    }
     ...
     * Post
     */
    async llmEndpointsPostRaw(requestParameters: LlmEndpointsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LLMEndpoint>> {
     ...
     * Post
     */
    async llmEndpointsPost(lLMEndpointCreate: LLMEndpointCreate, xUserId?: string | null, xUserName?: string | null, xUserEmail?: string | null, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LLMEndpoint> {
        const response = await this.llmEndpointsPostRaw({ lLMEndpointCreate: lLMEndpointCreate, xUserId: xUserId, xUserName: xUserName, xUserEmail: xUserEmail }, initOverrides);
        return await response.value();
    }
